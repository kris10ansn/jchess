...
public class BoardTest {
    ...
    public void perft_position1() {
        Board board = new Board("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1");
        assertEquals(20, singleDepthPerft(board));
    }

    @Test
    @Category(PerftTests.class)
    public void perft_position2() {
        Board board = new Board("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 1");
        assertEquals(48, singleDepthPerft(board));
    }
    ...
    public void perft_position3() {
        ...
        assertEquals(14, singleDepthPerft(board));
    }

    @Test
    @Category(PerftTests.class)
    public void perft_position4a() {
        Board board = new Board("r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1");
        assertEquals(6, singleDepthPerft(board));
    }

    @Test
    @Category(PerftTests.class)
    public void perft_position4b() {
    ...
    public void perft_position5() {
        ...
        assertEquals(44, singleDepthPerft(board));
    }

    @Test
    @Category(PerftTests.class)
    public void perft_position6() {
        Board board = new Board("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10");
        assertEquals(46, singleDepthPerft(board));
    }
